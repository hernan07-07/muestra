...
st.markdown("""
    ...
    /* FIX PARA LAS OPCIONES DEL COMBO (MODO PROGRAMADOR) */
    ...
    /* ELIMINACIÓN DE ESPACIOS ENTRE SECCIONES (Tus círculos rojos) */
...
if check_password():
    ...
    # NUEVO REGISTRO (SIN FORM PARA CONTROLAR EL ENTER)
    ...
    if not df_v.empty:
        ...
        for mesa in sorted(df_v['M_Int'].unique()):
            ...
            for idx, row in sub.iterrows():
                ...
                # Color de fondo por categoría en la lista
